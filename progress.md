...
| 8     | Advanced PQ + gRPC + UI Viz | ✅ Done | Real k-means PQ (train/quant/dequant), tonic gRPC (feature-gated), Chart.js score viz + enhanced UI | All major items complete; gRPC requires --features grpc + protoc for full build. |
